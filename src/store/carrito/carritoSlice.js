...
export const carritoSlice = createSlice({
  ...
  reducers: {
    ...
    deleteProduct: (state, {payload}) => {
      state.productCart = state.productCart.filter( product => product.id !== payload.id );
    },
  },
});

export const { payingProducts, clearCarrito, updateCarrito, setPrecio, deleteProduct } = carritoSlice.actions;
